        ...
        <Modal show={showModalAddActivity}>
          <ModalContainer>
            ...
            <form action="">
              ...
              options={[
                { value: "Atividades de iniciação à docência", label: "Atividades de iniciação à docência" },
                { value: "Atividades de iniciação à pesquisa", label: "Atividades de iniciação à pesquisa" },
                { value: "Atividades artístico-culturais e esportivas", label: "Atividades artístico-culturais e esportivas" },
                { value: "Atividades de participação e/ou organização de eventos", label: "Atividades de participação e/ou organização de eventos" },
                { value: "Experiências ligadas à formação profissional e/ou correlatas", label: "Experiências ligadas à formação profissional e/ou correlatas" },
                { value: "Produção Técnica e/ou Científica", label: "Produção Técnica e/ou Científica" },
                { value: "Vivências de gestão", label: "Vivências de gestão" },
              ]}/>
              <Title>Quantidade de horas:</Title>
              <Input value={hours} placeholder='Ex: 64' onChange={(e)=>setHours(e.target.value)}/>
              <div>
                <Title>Data de inicio:</Title>
                <Input value={dateStart} placeholder='Ex: 02/02/2020' onChange={(e)=>setDateStart(e.target.value)}/>
                <Title>Data do fim:</Title>
                <Input value={dateEnd} placeholder='Ex: 03/06/2021' onChange={(e)=>setDateEnd(e.target.value)}/>
              </div>
